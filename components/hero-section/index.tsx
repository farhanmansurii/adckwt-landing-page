...
export default function HeroSection() {
  ...
  return (
    <div className="relative h-[100vh] border-2  overflow-hidden">
      <div
          ...
          {/* <div className="max-w-screen-xl mx-auto px-4 py-28 gap-12 text-gray-600 overflow-hidden md:px-8 md:flex">
            <div className="flex-none space-y-5 ">
              <a
                ...
                className="inline-flex gap-x-6 text-white items-center rounded-full p-1 pr-6 border text-sm font-medium duration-150 hover:bg-white"
              >
...
// export default function HeroSection() {
//   return (
//     // <div className="w-screen relative overflow-hidden border aspect-video">
//     //   <img
//     //     className=" absolute md:-top-[100px] lg:-top-[200px] xl:-top-[300px] z-0"
//     //     src={"/assets/boat.jpg"}
//     //   />
//     // </div>

//     // <section className="relative bg-red-900 bg-cover bg-center bg-no-repeat">
//     //   <div className="absolute inset-0 "></div>

//     //   <div className="relative mx-auto max-w-7xl   px-4  sm:px-6 flex-col flex h-[75vh] md:h-[80vh] overflow-hidden lg:items-center ">
//     //     <div className="  h-full w-full  "></div>
//     //     <div className=" flex gap-4  flex-col pb-10 text-background text-2xl h-full w-10/12  ">
//     //       <div className="text-3xl md:text-4xl font-bold">
//     //         <div>Get Ready For a wider expansion of your business</div>
//     //       </div>
//     //       <div className="text-sm ">
//     //         Reach more market sectors for powerful business developement with
//     //         the expansion of the best transport services
//     //       </div>
//     //       <div className="flex gap-2">
...
//               Get Ready For a wider expansion of
...
//           </div>
//         </div>
//         <div className="mt-16 mb-16 flex flex-col  items-center   max-w-screen-xl justify-between mx-auto      sm:flex-row gap-10  md:mt-32">
//           {items.map((item, index) => (
//             <div
//               key={index}
//               className="flex w-10/12 group hover:bg-primary duration-150  md:w-fit border bg-white p-6 pr-10 text-center items-center shadow-lg gap-4 space-x-2 "
//             >
//               <div className="bg-primary w-24 text-white group-hover:text-primary group-hover:bg-white duration-150 p-4 group-hover:p-3  aspect-square">
//                 {item.icon}
//               </div>
//               <p className="text-2xl group-hover:text-white text-left text-wrap">
//                 {item.text}
//               </p>
//             </div>
//           ))}
